...
{% include figure image_path="/assets/images/2025-11-library-tidyverse.png" alt="Screenshot of a Praat editor window showing the amplitude wave form, spectrogram, and textgrid annotations." caption="Screenshot of a Praat editor window." %}{: style="max-width: 100%; display: block; margin: 2em auto;"}
...
don't have any firsthand knowledge or experience about what these
...
external corroboration, we are in the realm of [vibe coding](https://en.wikipedia.org/wiki/Vibe_coding). I like this term
...
Youtube video called "A vibe history of NES videogames"? No thanks.[^fn-abadox]
...
names into the output. (It generally ignores that rule of mine of mine,
giving me joyless unsolicited edits.)

So, the principles I am trying to develop in this mini-position
statement is that LLM assistance are
...
We should audit the results and make sure we comprehend it, or admit
upfront that this code is running on vibes. 

Sam Mehr has a stance I also quite like. LLMs are fine for code we don't feel
bothered to learn:
...
learning and what problems are worth solving the hard way seems very useful 
for an LLM user. 
