...
```{r version-differences, warning = FALSE, fig.width = 5, fig.height = 3, out.width = "80%", fig.cap="Comparison of mcmc_areas() in bayesplot 1.4.0 and 1.5.0"}
library(ggplot2)
...
```{r cake-model-results, fig.width = 5, fig.height = 5, out.width = "60%", fig.cap="Replications effects for recipe A"}
