...
```{r wp3, opts.label = "qq1", fig.cap = "Two plots of Q-Q points."}
ggplot(d) + 
...
```{r wp5, opts.label = "qq1", fig.cap = "A plot of Q-Q points with a confidence band."}
ggplot(d) + 
...
```{r wp6, opts.label = "qq1", fig.cap = "A plot of Q-Q points with a confidence band using robust estimates."}
ggplot(d) + 
  stat_worm(aes(sample = x_sample), robust = TRUE) +
  # for comparison
  geom_ribbon(
