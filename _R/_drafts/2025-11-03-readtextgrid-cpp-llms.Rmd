...
compromise between verbosity and human-readability, we could imagine writing out 
the data in a more tabular organization, with lines of `! column names`:
...
long-format textgrids. I knew this. I put this an issue in 2020. And this
...
*semantics*. They don't have any firsthand knowledge or experience about what
...
I was benchmarking the code and trying to improve it and found that it was 
the new parser was slower than the legacy, regular expression based system. 
...
bench::mark(
  ...
  new_parser = readtextgrid:::r_read_textgrid_lines(path_tg_lines)
)
```
