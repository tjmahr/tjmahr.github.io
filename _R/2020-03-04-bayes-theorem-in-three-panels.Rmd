...
.a <- list()
.a$nls <- downlit::autolink_url("stats::nls()")
.a$add_epred <- downlit::autolink_url("tidybayes::add_epred_draws()")
```
...
[`add_epred_draws()`](`r .a$add_epred`) from the tidybayes package. An
...
nonlinear least squares [`nls()`](`r .a$nls`) to illustrate what a
