...
```{r, fig.cap="Spectrogram of me saying 'library tidyverse library brms'"}
library(tidyverse)
library(ggplot2)
...
tjmisc::ggpreview(width = 8, height = 4)
```
...
[proc-roc]: `r downlit::autolink_url("pROC::roc")` "Documentation for pROC::roc()"
...
[rlang-cdu]: `r downlit::autolink_url("rlang::check_dots_used")` "Documentation for check_dots_used()"
