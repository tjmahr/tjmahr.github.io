...
glm <- glm(cbind(`n left handed`, `n right handed`) ~ sex, binomial, df_version)
summary(glm)
```
...
```{r model_program, cache = TRUE, dependson = "model_code", results = 'hide'}
...
at `r q_info[2]` with 90% of the values between [`r q_info[1]`, `r q_info[3]`].
